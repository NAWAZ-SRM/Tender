...
//             try {
//                 const response = await fetch('http://localhost:5000/api/cargo'); // Backend URL for fetching cargo
//                 if (!response.ok) {
...
//         try {
//             const response = await fetch(`http://localhost:5000/api/cargo/${cargoId}`);  // Backend URL for fetching specific cargo
//             if (!response.ok) {
...
//                                             <p>Estimated Price: ${cargo.estimatedPrice}</p> {/* Display estimated price */}
...
//             try {
//                 const response = await fetch(`http://localhost:5000/api/bids/${cargoId}`);  // Backend URL for fetching bids for specific cargo
...
//                 ))
//             ) : (
//                 <p>No bids available for this cargo.</p>
//             )}
//         </ul>
//     );
// }
